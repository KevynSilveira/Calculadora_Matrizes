...
class MatrixInputFrame(ttk.Frame):
    def __init__(self, master, title="Matriz", max_dim=10):
        ...
        self.entries_frame = ttk.Frame(self, padding=(0, 0, 0, 0))
    ...
    def create_matrix_entries(self):
        ...
        for i in range(rows):
            ...
            for j in range(cols):
                ...
                entry.grid(row=i, column=j, padx=1, pady=1, ipady=3, ipadx=3)
    ...
    def get_matrix(self):
        try:
            ...
            messagebox.showerror("Erro de Entrada", f"Valor inválido em '{self.title_label['text']}'. Insira apenas números.")
            return None
        except IndexError:
